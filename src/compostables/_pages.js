export function usePages() {
    ...
    const student = {
        ...
        background_color: "from-violet-500 dark:from-violet-950",
    ...
    const company = {
        ...
        background_color: "from-emerald-500 dark:from-emerald-950",
    ...
    const nav = {
        ...
        background_color: "from-rose-500 dark:from-rose-950",
