<template>
    ...
    <section>
        <h2>
            Faglige emner i Utviklerkurset:
        </h2>
        <p>
            Kort fortalt begynner vi med å lage enkle statiske nettsider ved bruk av HTML5 og CSS3. Vi går videre til JavaScript og bruker størsteparten av tiden innen det språket. Deretter er målet å gjøre nettsidene dynamiske, det betyr å hente ny oppdatert informasjon inn på våre eksisterende nettsider. Til det benytter vi JSON, og vi kontakter API fra eksterne servere. Til slutt går vi et steg videre, og oppretter vår egen server og JSON-database gjennom bruk av JSON-server, for å simulere backend.
        </p>
        <p>
            Brukere med forkunnskaper har gjerne sett på Express server og mongoDB i stedet for JSON-server løsningen, men det er ikke en del av hoveddelen alle skal igjennom i Utviklerkurset per nå.
        </p>
        <p>
            I tillegg har vi et litt større prosjekt hvor deltakerne (sammen eller alene) skal levere en komplett løsning av et nettsted.
        </p>
        <p>
            Tematisk innhold:
        </p>
    ...
    <section>
        ...
        <p>
            Det har vært gjennomført 6 kurs allerede med gode resultater. Deltakerne i kurset har fått praksisplasser, noen har fått mersmak på utdannelse, og andre igjen har funnet seg spennende jobber innenfor feltet. Vi har også fått gode tilbakemelding fra praksisplassene om at deltakerne besitter relevante og gode kunnskaper som bedriftene har hatt bruk for.
        </p>
    </section>

    <section>
        <h2>
            Hvorfor ansette våre deltakere?
        </h2>
        <p>
            Deltakerne som er på vårt kurs har fra starten av en bakgrunn som hobby-programmere og en genuin interesse for IT og utvikling. De evner å lære på kort tid og får mye praktisk erfaring med utvikling hos oss under kursperioden.
        </p>
        <p>
            På kurset får deltakerne forsøkt seg både som selvstendig utvikler og som en del av et team, samt arbeide både fysisk på kurs-lokalet, og digitalt via hjemmekontor ved behov. Dette gjør at deltakerne er klar for de fleste arbeidsformer en arbeidsplass har å by på.
        </p>
        <p>
            Vi følger deltaker og bedriften nøye opp under praksis, så om ikke arbeidsforholdet fungerer optimalt, er vi raskt på plass for å finne en løsning som passer bedre.
        </p>
        <p>
            Når deltakeren er på praksis hos din bedrift dekker Nav hele lønnen, slik at dere kan fokusere på opplæring og tilrettelegging. Dette gjør at dere uforpliktende kan teste ut om deltakeren passer inn på deres arbeidsplass.
        </p>
        <p>
